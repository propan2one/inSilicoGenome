...
#input_fasta="pMRT10279.fa"
#FASTA=input_fasta
#range_start=5
#range_end=500
#csv_file='pMRT10279.tsv'

def write_fasta_genome(output, sequence):
    """
    Writes name/sequence to file in FASTA format #From insilicogenome module
    ...
    n = 80	# return line every 70 characters
...
def fasta_iter(FASTA):
    """
    Fasta file parser #From insilicogenome module
...
def create_variants(FASTA, vcf, **kwargs):
    ...
    write_fasta_genome(output_fasta, sequence)
...
def multiple_FASTA_one_variation(FASTA, range_start, range_end, size):
    ...
    for i in vcflist:
        ...
        write_fasta_genome(output_fasta, sequence_tmp)
